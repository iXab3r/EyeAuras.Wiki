...
## 2. Sign up and purchase a license
...
- After installation, go to `C:\Program Files (x86)\ControlMyJoystick 5.5.78.50\Driver\Joystick` and run the uninstall `.bat` file as administrator.
...
After applying the changes, redirect buttons will appear in the bottom panel so you can enable or disable redirection.
...
- More details: [here](https://wiki.eyeauras.net/en/Lineage/parsec)

## 7. Video guide

If you prefer visual instructions, we’ve prepared a detailed video guide for setup and usage.