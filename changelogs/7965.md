...
For now, I would recommend to use built-in `ComplexFileProvider`, `InMemoryFileProvider`, `InMemoryFileInfo` and `LazyInMemoryFileInfo` which allow you to easily add new content to your pages.
