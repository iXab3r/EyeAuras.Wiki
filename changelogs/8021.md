...
> **IMPORTANT!** To apply new compilation mode, you have to `Upload` new revision of the pack. For now, compilation is done on a client-side. Eventually, it will be shifted to server-side, like the rest of Packing configuration, but this is something for **2026**. 
{.is-info}
