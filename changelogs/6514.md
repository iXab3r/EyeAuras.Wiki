...
[Replay Demo](https://www.youtube.com/watch?v=x8Di5ax95Fo)
...
- It is now in the early testing phase, and in the coming weeks, there will be a bunch of scripting-related updates, but if you want to start coding - do not hesitate to try out the newer system and, if you have any questions, contact me on Discord and ask anything. Me and **linqse** will do our best on writing documentation about the new API with examples and everything.  
- NuGet packages - they are already supported but are disabled for now. I want to clean up all potential internal issues first and after that allow people to use external dependencies.
