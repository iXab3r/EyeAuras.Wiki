...
We got new overlays, [major improvements in NuGet packages](https://wiki.eyeauras.net/en/scripting/nuget) and external assemblies integration, editor improvements and, finally Export and Live Import, which allow to use EA **and** your favourite IDE of choice together. 
...
### UI performance
Become better in 2024, but still have a long way to go, especially with large number of auras (500+).
