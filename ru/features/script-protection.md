...
published: true
date: 2025-03-12T00:47:28.460Z
tags: 
editor: markdown
dateCreated: 2025-03-12T00:43:32.176Z
---

# 🔒 Защита скриптов в EyeAuras (ALPHA)
...
> Важно! После изменения настроек пакования, не забудьте сделать `Upload` - ваши настройки влияют только на СЛЕДУЮУЩУЮ ревизию пака! 
{.is-info}
