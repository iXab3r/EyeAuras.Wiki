---
title: Нестабильный API SendInput для скриптов
description: 
published: true
...
---
> Для навигации по AI-first API см. [AI Input, Hooks, Hotkeys](./windows-subsystems/input-hooks-hotkeys), [AI Window Handles](./windows-subsystems/window-handles) и [AI OSD Selection](./osd/selection) — там описаны нестабильные input-хелперы и связанные низкоуровневые сервисы.
{.is-info}

> УСТАРЕЛО — обновлённый API находится [здесь](/scripting/api/ISendInputScriptingApi)
{.is-warning}

# ISendInputUnstableScriptingApi
