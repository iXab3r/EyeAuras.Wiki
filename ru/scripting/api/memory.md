---
title: API работы с памятью
description: Документация по API работы с памятью
published: true
...
---
> Для AI-first навигации см. [AI Memory / Processes](./memory/processes) — про readers процессов и варианты подключения, [AI Frida SDK](./nuget/frida-sdk) — про дополнительные Frida/CAgent API, и [AI ReProcess](./reverse-engineering/reprocess) — про интеграцию UI для reverse engineering.
{.is-info}
