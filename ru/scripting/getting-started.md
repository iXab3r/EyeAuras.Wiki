...
# Hello, world!
Кому лень читать - живой пример [здесь](/scripting/examples/basic/hello-world), он подойдет для новичков.
А вот [этот](/scripting/examples/basic/image-search) - более сложный, для тех, кто уже знаком с C#
